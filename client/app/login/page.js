      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Welcome to Secure Chat</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/register" className="text-whatsapp-green hover:text-whatsapp-green-dark font-medium">
                Sign up
              </Link>
            </p>
          </div>
